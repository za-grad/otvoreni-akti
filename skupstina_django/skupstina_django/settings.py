"""
Django settings for skupstina_django project.
...
ROOT_URLCONF = 'skupstina_django.urls'
...
WSGI_APPLICATION = 'skupstina_django.wsgi.application'
...
STATICFILES_DIRS = (base('skupstina_django/skupstina/static'),)
